...
const temples = [
    ...
    },
    {
        ...
        area: 28472,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/bentonville-arkansas/400x400/34410870d7d011ed8402eeeeac1ec672bdc0ce45.jpeg"
    },
    {
        ...
        area: 44207,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/dallas-texas/2018/400x400/Dallas-Texas-Temple12.jpg"
    },
    {
        ...
        area: 10700,
        imageUrl: "https://content.churchofjesuschrist.org/templesldsorg/bc/Temples/photo-galleries/edmonton-alberta/400x250/edmonton-alberta-temple-winter-1130226-wallpaper.jpg"
    }
];

// Dynamically display temples with filtering options
const templeGallery = document.querySelector('.temple-gallery');

function displayTemples(filteredTemples) {
    templeGallery.innerHTML = ''; // Clear current temples

    filteredTemples.forEach(temple => {
        // Create a div for the temple card
        const templeCard = document.createElement('div');
        templeCard.classList.add('temple-card');

        // Add temple image with native lazy loading
        ...
        // Append details to the temple card
...
// Filter temples based on the navigation link clicked
navItems.forEach(link => {
    link.addEventListener('click', (event) => {
        ...
        sectionTitle.textContent = filter.charAt(0).toUpperCase() + filter.slice(1);
...
// Initially display all temples on page load
